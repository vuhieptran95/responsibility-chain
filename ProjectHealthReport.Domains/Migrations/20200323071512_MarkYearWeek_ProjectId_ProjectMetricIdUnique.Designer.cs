...
namespace ProjectHealthReport.Domains.Migrations
{
    ...
    [Migration("20200323071512_MarkYearWeek_ProjectId_ProjectMetricIdUnique")]
    partial class MarkYearWeek_ProjectId_ProjectMetricIdUnique
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectHealthReport.DataAccess.DoDReport", b =>
                {
                    ...
                    b.Property<int>("ProjectMetricId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProjectMetricId");

                    b.HasIndex("YearWeek", "ProjectId", "ProjectMetricId")
                        .IsUnique();
            ...
            modelBuilder.Entity("ProjectHealthReport.DataAccess.ProjectMetric", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjectHealthReport.DataAccess.DoDReport", b =>
                {
                    ...
                    b.HasOne("ProjectHealthReport.DataAccess.ProjectMetric", "ProjectMetric")
                        .WithMany("DoDReports")
                        .HasForeignKey("ProjectMetricId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });

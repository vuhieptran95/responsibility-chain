...
namespace ProjectHealthReport.Domains.Migrations
{
    ...
    [Migration("20200320021447_AddDoDTable")]
    partial class AddDoDTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectHealthReport.DataAccess.DoDReport", b =>
                {
                    ...
                    b.Property<int?>("MetricStatusThresholdId")
                        .HasColumnType("int");

                    b.Property<int>("MetricsStatusThresholdId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MetricStatusThresholdId");
            ...
            modelBuilder.Entity("ProjectHealthReport.DataAccess.MetricStatusThreshold", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("MetricStatusThresholds");
                });
            ...
            modelBuilder.Entity("ProjectHealthReport.DataAccess.DoDReport", b =>
                {
                    b.HasOne("ProjectHealthReport.DataAccess.MetricStatusThreshold", "MetricStatusThreshold")
                        .WithMany("DoDReports")
                        .HasForeignKey("MetricStatusThresholdId");
            ...
            modelBuilder.Entity("ProjectHealthReport.DataAccess.MetricStatusThreshold", b =>
                {
                    b.HasOne("ProjectHealthReport.DataAccess.Metric", "Metric")
                        .WithMany("MetricStatusThresholds")
